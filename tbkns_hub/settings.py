...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'web-production-5ee23.up.railway.app').split(',')
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'TBKNS HUB <noreply@tbknshub.com>')
